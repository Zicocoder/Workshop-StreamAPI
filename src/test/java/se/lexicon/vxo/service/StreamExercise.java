...
public class StreamExercise {
    ...
    public void task3() {
        ...
        amount=people.stream().filter(p-> p.getLastName().equalsIgnoreCase
                ("Andersson")).count();
    ...
    public void task8() {
      ...
      // Lambda option 1: optional = people.stream().min((p1, p2) -> p1.getDateOfBirth().compareTo(p2.getDateOfBirth()));
    ...
    public void task10() {
        ...
        optional = Optional.of(people.stream().filter(
        p -> p.getPersonId() == personId).findFirst().get().getDateOfBirth().format(formatter).toUpperCase().toString());
    ...
    public void task12() {
        ...
        //result=people.stream().filter(p->p.getFirstName().equalsIgnoreCase(new StringBuilder(p.getFirstName().reverse)))
